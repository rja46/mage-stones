...
public class BlockEntites {
    ...
    public static void initialize() {
        LIGHT_CRYSTAL_BLOCK_ENTITY = Registry.register(
                Registries.BLOCK_ENTITY_TYPE, "mage_stones:light_crystal_block_entity", BlockEntityType.Builder.create(LightCrystalBlockEntity::new, ModBlocks.LIGHT_MAGE_STONE_CRYSTAL).build(null)
        );
        COLD_CRYSTAL_BLOCK_ENTITY = Registry.register(
                Registries.BLOCK_ENTITY_TYPE, "mage_stones:cold_crystal_block_entity", BlockEntityType.Builder.create(LightCrystalBlockEntity::new, ModBlocks.COLD_MAGE_STONE_CRYSTAL).build(null));
    }
}
